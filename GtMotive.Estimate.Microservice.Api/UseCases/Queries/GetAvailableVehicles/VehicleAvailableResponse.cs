...
{
    /// <summary>Available vehicle response DTO.</summary>
    public sealed class VehicleAvailableResponse
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleAvailableResponse"/> class.
        /// </summary>
        ...
        public VehicleAvailableResponse(Guid vehicleId, string brand, string model, DateTime manufactureDate, bool isAvailable)
        {
            VehicleId = vehicleId;
            Brand = brand;
            Model = model;
